            ...
            <div className="relative w-full max-w-[640px] ml-auto rounded-[14px] border border-[#333333] bg-[#111111] shadow-[0_40px_80px_rgba(0,0,0,0.8),_inset_0_1px_0_rgba(255,255,255,0.05)] overflow-hidden">
              ...
              <div className="p-2 bg-[#0A0A0A]">
                {[
                  ...
                  <div
                    key={i}
                    className="flex items-center justify-between p-4 hover:bg-[#161616] rounded-[8px] transition-colors cursor-pointer border border-transparent hover:border-[#262626]"
                  >
                    <div className="flex items-center gap-4 w-1/2">
                      ...
                      <div>
                        <div className="text-[14px] font-semibold text-[#F3EDE4] leading-tight mb-1">
                          {user.name}
                        </div>
                    ...
                    <div className="flex items-center gap-4 w-1/2 justify-end">
                      ...
                      <span className="text-[13px] font-medium text-[#A3A3A3] w-10 text-right">
                        {user.capacity}
                      </span>
                    </div>
                  </div>
