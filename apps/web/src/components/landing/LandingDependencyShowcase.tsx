      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-10 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          ...
          <div className="order-2 lg:order-1">
            ...
            {/* DAG flow */}
            <div className="p-6 rounded-2xl bg-slate-950/80 border border-white/[0.08] shadow-2xl space-y-3">
              {/* Node layout */}
              <div className="flex flex-col gap-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {nodes.slice(0, 2).map(node => {
                    ...
                    return (
                      <div
                        key={node.id}
                        className={`p-3.5 rounded-xl border ${cfg.border} ${cfg.bg} space-y-1.5`}
                      >
                ...
                {(() => {
                  ...
                  return (
                    <div
                      className={`p-4 rounded-xl border ${cfg.border} ${cfg.bg} flex items-center justify-between`}
                    >
              ...
              {/* Risk alert */}
              <div className="mt-3 p-3.5 rounded-xl bg-rose-500/[0.07] border border-rose-500/25 flex items-center justify-between gap-3">
