    ...
    <section id="ai" className="py-24 sm:py-36 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-10 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          {/* Left: text */}
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-violet-500/10 border border-violet-500/25 text-[11px] font-bold text-violet-300 mb-6 tracking-wide">
          ...
          <div className="relative">
            ...
            <div className="relative p-6 sm:p-8 rounded-2xl bg-slate-950/80 border border-violet-500/20 backdrop-blur-xl">
              {/* Header */}
              ...
              <div
                key={current.id}
                className={`p-5 rounded-xl ${current.bgColor} border ${current.borderColor} transition-all duration-300`}
              >
