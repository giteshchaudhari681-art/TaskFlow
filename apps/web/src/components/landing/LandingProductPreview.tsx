...
export const LandingProductPreview: React.FC = () => {
 return (
  <section id="product" className="py-24 sm:py-32 relative overflow-hidden">
   {/* Subtle ambient glow */}
   <div className="pointer-events-none absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] bg-taskflow-surface from-sky-500/[0.05] /[0.05] rounded-full blur-3xl" />
   ...
   <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-10 relative z-10">
    ...
    <div className="relative rounded-lg overflow-hidden border border-white/[0.10] shadow-[0_40px_120px_rgba(0,0,0,0.7)] bg-[#0c1018]">
     {/* Browser chrome */}
     ...
     <div className="flex h-[520px] sm:h-[600px]">
      ...
      <div className="hidden sm:flex flex-col w-[220px] bg-[#0a0e18] border-r border-white/[0.06] p-4 gap-2 shrink-0">
       ...
       <div className="flex items-center gap-2 px-2 py-1 mb-3">
        <div className="w-6 h-6 rounded-lg bg-taskflow-surface flex items-center justify-center">
      ...
      <div className="flex-1 overflow-hidden p-6 flex flex-col gap-5">
       ...
       {/* Health bar */}
       <div className="p-4 rounded-md bg-slate-900/80 border border-white/[0.07] flex items-center justify-between gap-4">
        <div className="flex items-center gap-3">
         <div className="w-12 h-12 rounded-md bg-emerald-500/15 border border-emerald-500/30 flex items-center justify-center font-black text-emerald-400 text-base">
          94
         </div>
         <div>
       ...
       <div className="grid grid-cols-3 gap-3 flex-1">
        {/* Velocity chart */}
        <div className="p-4 rounded-md bg-slate-900/60 border border-white/[0.07] flex flex-col gap-3">
        ...
        <div className="p-4 rounded-md bg-slate-900/60 border border-white/[0.07] flex flex-col gap-3">
         ...
         <div className="w-full h-2 rounded-full bg-white/[0.08] overflow-hidden">
          <div
           className="h-full bg-taskflow-surface rounded-full"
           style={{ width: '84%' }}
          />
         </div>
        ...
        {/* AI Risk panel */}
        <div className="p-4 rounded-md bg-taskflow-elevated border border-taskflow-border flex flex-col gap-3">
         <div className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">
          AI Risk
         </div>
         ...
         <div className="flex gap-1 flex-wrap">
          {['OPS-080', 'OPS-094', 'MS-02'].map(tag => (
           <span
            key={tag}
            className="px-1.5 py-0.5 rounded text-[9px] font-mono font-bold text-taskflow-text bg-taskflow-elevated"
           >
            {tag}
           </span>
          ))}
