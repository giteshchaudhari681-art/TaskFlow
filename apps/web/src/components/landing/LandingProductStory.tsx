  ...
  <section className="py-24 sm:py-36 relative overflow-hidden">
   ...
   <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-10">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-8">
     {/* Before: The old way */}
     <div className="relative p-8 sm:p-10 rounded-lg bg-rose-950/10 border border-rose-900/20 overflow-hidden">
      ...
      {/* Terminal snippet */}
      <div className="mt-8 p-4 rounded-md bg-slate-950/60 border border-rose-900/20 font-mono text-[11px] text-rose-300/60">
     ...
     {/* After: TaskFlow */}
     <div className="relative p-8 sm:p-10 rounded-lg bg-sky-950/10 border border-sky-500/20 overflow-hidden">
      <div className="absolute top-0 left-0 right-0 h-px bg-taskflow-surface from-transparent to-transparent" />
      ...
      {/* Status badge */}
      <div className="mt-8 p-4 rounded-md bg-slate-950/60 border border-sky-500/15 font-mono text-[11px] flex items-center justify-between">
    ...
    <div className="mt-14 grid grid-cols-2 sm:grid-cols-4 gap-5">
     {[
      ...
      { stat: '100%', label: 'Dependency visibility', color: 'text-taskflow-text' },
      { stat: '3×', label: 'Faster incident resolution', color: 'text-amber-400' },
     ].map(({ stat, label, color }) => (
      <div
       key={label}
       className="p-5 rounded-md bg-white/[0.03] border border-white/[0.06] hover:border-white/[0.10] transition-colors"
      >
