        ...
        <div className="grid lg:grid-cols-[1fr,1fr] gap-20 items-center">
            ...
            >
              <div className="flex flex-col gap-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[11px] font-bold tracking-wider text-[#EF4444] uppercase">High Priority</span>
                </div>
            ...
            >
              <div className="flex flex-col gap-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[11px] font-bold tracking-wider text-[#3B82F6] uppercase">AI Suggestion</span>
                </div>
            ...
            >
              <div className="flex flex-col gap-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[11px] font-bold tracking-wider text-[#22C55E] uppercase">Ready to Ship</span>
                </div>
          ...
          >
            ...
            <h2 className="font-display text-[clamp(2.5rem,4vw,3.5rem)] font-medium tracking-tight leading-[1.05] mb-8 text-[#F3EDE4]">
              Projects don't fail at launch.<br />They fail weeks before.
            </h2>
            <p className="text-[1.15rem] text-[#A3A3A3] leading-relaxed mb-12 font-sans max-w-[500px]">
              TaskFlow helps you spot risks early, keep work moving, and make smarter decisions with AI. Most tools show you what happened. TaskFlow shows you what's about to happen.
            </p>
            ...
            <div className="grid grid-cols-3 gap-6 w-full pt-8 border-t border-[#262626]">
              <div>
                <div className="text-[2.2rem] font-display text-[#3B82F6] leading-none mb-2">78%</div>
                <div className="text-[11px] text-[#8A8A8A] font-medium uppercase tracking-wide">Fewer missed deadlines</div>
              </div>
              <div>
                <div className="text-[2.2rem] font-display text-[#22C55E] leading-none mb-2">6x</div>
                <div className="text-[11px] text-[#8A8A8A] font-medium uppercase tracking-wide">Faster project setup</div>
              </div>
              <div>
                <div className="text-[2.2rem] font-display text-[#F3EDE4] leading-none mb-2">100%</div>
                <div className="text-[11px] text-[#8A8A8A] font-medium uppercase tracking-wide">Team visibility</div>
              </div>
            </div>
          </motion.div>
