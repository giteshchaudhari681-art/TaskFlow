  ...
  return (
    <div className="space-y-3">
      {milestones.map(m => (
        <div
          key={m.name}
          className="p-4 rounded-xl bg-slate-900/80 border border-white/[0.07] hover:border-white/[0.11] transition-colors"
        >
          ...
          <div className="w-full h-1.5 rounded-full bg-white/[0.07] overflow-hidden">
            <div
              className={`h-full rounded-full ${m.progress === 100 ? 'bg-emerald-500' : 'bg-gradient-to-r from-sky-500 to-indigo-500'}`}
  ...
  return (
    <div className="space-y-2">
      {events.map((ev, i) => (
        <div
          key={i}
          className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-900/60 border border-white/[0.06] hover:border-white/[0.09] transition-colors"
        >
          <div
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-8">
            {/* Tab bar */}
            <div className="flex gap-1 p-1 rounded-xl bg-white/[0.04] border border-white/[0.07] mb-4 w-fit">
            ...
            {/* Panel */}
            <div className="p-5 sm:p-7 rounded-2xl bg-slate-950/60 border border-white/[0.08] shadow-2xl min-h-[340px]">
