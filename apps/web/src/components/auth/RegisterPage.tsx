...
export const RegisterPage: React.FC<RegisterPageProps> = ({ onSwitchToLogin }) => {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto my-4 sm:my-8 grid grid-cols-1 md:grid-cols-12 rounded-2xl bg-slate-900/90 backdrop-blur-xl border border-white/[0.08] shadow-elevation-4 overflow-hidden">
      ...
      <div className="md:col-span-5 bg-gradient-to-b from-slate-950 via-slate-900 to-sky-950 p-6 sm:p-8 flex flex-col justify-between relative overflow-hidden border-b md:border-b-0 md:border-r border-white/[0.08]">
