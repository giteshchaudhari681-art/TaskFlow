...
export const LABEL_COLOR_MAP: Record<string, LabelColorConfig> = {
 ...
 cyan: {
  bg: 'bg-taskflow-accent-subtle',
  text: 'text-taskflow-accent',
  border: 'border-taskflow-accent',
  dot: 'bg-taskflow-accent',
  accent: '#06b6d4',
 },
 blue: {
  bg: 'bg-blue-500/10',
